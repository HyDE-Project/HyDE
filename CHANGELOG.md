...
- Theme: `theme.switch.sh` now logs `hyq`'s own error output when it fails to dump `hypr.theme` to Lua, instead of discarding it; the generic "could not dump hypr.theme" message previously left no way to tell why (#2098)
