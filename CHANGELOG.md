...
### Fixed
- Waybar: the theme module and the HyDE menu open the theme picker again; they called `themeselect`, which the v26.7.4 migration renamed to `theme.select`, so a middle click did nothing
