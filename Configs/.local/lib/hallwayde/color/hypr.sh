...
# Auto-generated by HALLwayDE // Read-only
# // ----------------------------
# HALLwayDE Theme: $HALLWAYDE_THEME
# Configuration File: "$HALLWAYDE_THEME_DIR/hypr.theme"
...
# exec = \${RUN_CMD}"
# source = \${SOURCE_FILE}
# exec = hallwayde-shell walbash code \$CODE_THEME # Setting the code theme
