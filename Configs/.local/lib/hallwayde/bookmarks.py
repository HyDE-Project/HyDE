...
class XDGPaths:
    def __init__(self):
        ...
        self.CACHE_DIR = os.path.join(self.xdg_cache, "hallwayde")
        self.CONFIG_DIR = os.path.join(self.xdg_config, "hallwayde")
        self.RUNTIME_DIR = os.path.join(self.xdg_runtime, "hallwayde")
        self.DATA_DIR = os.path.join(self.xdg_data, "hallwayde")
...
class BookmarkManager:
    ...
    def find_bookmark_files(self):
        ...
        # Custom .lst files
        for path in [
            os.path.join(self.xdg.xdg_config, "hallwayde/bookmarks.lst"),
        ]:
            if os.path.exists(path):
                files.append(path)
        return files
