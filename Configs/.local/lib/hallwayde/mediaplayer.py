...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "hallwayde", "config")
    colors_file = os.path.join(xdg_cache_home(), "hallwayde/wall.dcol")
    ...
    # You can configure these in ~/.config/hallwayde/config.toml
