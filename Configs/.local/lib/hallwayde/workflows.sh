...
if ! source "$(which hallwayde-shell)"; then
    echo "[$0] :: Error: hallwayde-shell not found."
    echo "[$0] :: Is HALLwayDE installed?"
    exit 1
fi
...
#*┌────────────────────────────────────────────────────────────────────────────┐
#*│ # HALLwayDE Controlled content // DO NOT EDIT                                   │
#*│ # This file sets the current workflow for Hyprland                         │
#*│ # Edit or add workflows in the ./workflows/ directory                      │
#*│ # and run the 'hallwayde-shell workflows --select' command to update this file          │
#*│                                                                            │
...
argparse_program "hallwayde-shell workflows"
argparse_header "HALLwayDE Workflow Selector"
