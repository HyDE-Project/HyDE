...
cached_search_dir="${XDG_CACHE_HOME:-$HOME/.cache}/hallwayde/landing/websearch"
declare -A SITES SITES_ICON
search_file=(
    "$SHARE_DIR/hallwayde/websearch.lst"
    "$XDG_CONFIG_HOME/hallwayde/websearch.lst")
load_search_engines() {
    local lst_files=()
...
main() {
    ...
    argparse_program "hallwayde-shell rofi.websearch"
    argparse_header "HALLwayDE Web Search"
