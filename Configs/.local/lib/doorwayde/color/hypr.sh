...
# Auto-generated by DOORwayDE // Read-only
# // ----------------------------
# DOORwayDE Theme: $DOORWAYDE_THEME
# Configuration File: "$DOORWAYDE_THEME_DIR/hypr.theme"
...
# exec = \${RUN_CMD}"
# source = \${SOURCE_FILE}
# exec = doorwayde-shell walbash code \$CODE_THEME # Setting the code theme
