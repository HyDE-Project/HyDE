...
WALLBASH_SCRIPTS="${WALLBASH_SCRIPTS:-$hallwaydeConfDir/wallbash/scripts}"
hypr_border=10
...
# For user configuration edit '${confDir}/dunst/dunst.conf' then run 'hallwayde-shell wallbash dunst' to apply changes.
# Updated dunst configuration: https://github.com/HALLwayDE-Project/HALLwayDE/blob/master/Configs/.config/dunst/dunst.conf

# HALLwayDE specific section // To override the default configuration edit '${cacheDir}/wallbash/dunst.conf'
# ------------------------------------------------------------------------------
[global]
...
# [Type-2]
# appname = "HALLwayDE Notify"
# format = "<span size="250%">%s</span>\n%b"

[Type-1]
appname = "HALLwayDE Alert"
format = "<b>%s</b>"
...
# HALLwayDE Mandatory section // Non overridable // please open a request in https://github.com/HALLwayDE-Project/HALLwayDE
# ------------------------------------------------------------------------------
[global]

# to change font and size, set the following variables in ~/.config/hallwayde/config.toml
# [notification]
