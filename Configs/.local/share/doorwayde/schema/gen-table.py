...
def generate_markdown_table(toml_file_path):
    ...
    output_lines = [
        ...
        "DOORwayDE exposes `xdg_config/doorwayde/config.toml` file for users to modify. This lets users have the ability to interact the scripts without using command arguments.",
        "",
