...
```toml
"$schema" = "https://raw.githubusercontent.com/HyDE-Project/HyDE/refs/heads/master/Configs/.local/share/doorwayde/schema/config.toml.json"
```
---
### [battery.notify]
...
| Key | Description | Default |
| --- | ----------- | ------- |
| applet_bluetooth | Bluetooth applet. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-bluetooth-applet.service -t service -- blueman-applet |
| applet_network_manager | Network manager applet. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-network-manager-applet.service -t service -- nm-applet --indicator |
| applet_removable_media | Removable media applet. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-removable-media-applet.service -t service -- udiskie --no-automount --smart-tray |
| auth_dialogue | Authentication dialogue. | doorwayde-shell app -t service -- polkitkdeauth.sh |
| bar | Bar. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-bar.scope -t scope -- waybar.py --watch |
| battery_notify | Battery notification script. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-battery-notify.service -t service -- batterynotify.sh |
| blue_light_filter_daemon | Blue-light filter daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-blue-light-filter.service -t service -- hyprsunset |
| clipboard_persist | Clipboard persist daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-clipboard-persist.service -t service wl-clip-persist --clipboard regular |
...
| idle_daemon | Idle daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-idle.service -t service -- hypridle |
| image_clipboard | Image clipboard daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-image-clipboard.service -t service wl-paste --type image --watch cliphist store |
| notifications | Notification daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-notifications.service -t service -- dunst |
...
| text_clipboard | Text clipboard daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-text-clipboard.service -t service wl-paste --type text --watch cliphist store |
| wallpaper | Wallpaper script. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-wallpaper.service -t service -- wallpaper.sh --start --global |
| xdg_portal_reset | XDG portal reset script. | doorwayde-shell resetxdgportal.sh |
...
| --- | ----------- | ------- |
| applet_bluetooth | Bluetooth applet. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-bluetooth-applet.service -t service -- blueman-applet |
| applet_network_manager | Network manager. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-network-manager-applet.service -t service -- nm-applet --indicator |
| applet_removable_media | Removable media manager. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-removable-media-applet.service -t service -- udiskie --no-automount --smart-tray |
| auth_dialogue | Authentication dialogue. | doorwayde-shell app -t service -- polkitkdeauth.sh |
| bar | Bar. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-bar.scope -t scope -- waybar.py --watch |
| battery_notify | Battery notification script. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-battery-notify.service -t service -- batterynotify.sh |
| blue_light_filter_daemon | Blue-light filter daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-blue-light-filter.service -t service -- hyprsunset |
...
| idle_daemon | Idle daemon. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-idle.service -t service -- hypridle |
| image_clipboard | Image clipboard. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-image-clipboard.service -t service wl-paste --type image --watch cliphist store |
| notifications | Notifications. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-notifications.service -t service -- dunst |
...
| text_clipboard | Text clipboard. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-text-clipboard.service -t service wl-paste --type text --watch cliphist store |
| wallpaper | Wallpaper script. | doorwayde-shell app -u hyde-$XDG_SESSION_DESKTOP-wallpaper.service -t service -- wallpaper.sh --start --global |
| xdg_portal_reset | XDG portal reset script. | doorwayde-shell resetxdgportal.sh |
...
doorwayde-shell rofi.bookmarks.sh configuration.
...
'doorwayde-shell hyprlock select' configuration.
...
doorwayde-shell rofi.websearch.sh configuration.
