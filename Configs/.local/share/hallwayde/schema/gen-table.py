...
def generate_markdown_table(toml_file_path):
    ...
    output_lines = [
        ...
        "HALLwayDE exposes `xdg_config/hallwayde/config.toml` file for users to modify. This lets users have the ability to interact the scripts without using command arguments.",
        "",
