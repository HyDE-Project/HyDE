...
export const sendMessage = (text) => {
    ...
    else if (text.startsWith('+')) { // Next page
            const lastQuery = waifuContent.at(-1);
            waifuContent.fetch(`${lastQuery.realTagList.join(' ')} ${lastQuery.page + 1}`)
    }
