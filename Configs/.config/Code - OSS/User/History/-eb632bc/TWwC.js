...
import onscreenkeyboard from 'modules/onscreenkeyboard/onscreenkeyboard.js';
                ...
                ConfigSection({
                    name: 'Effects', children: [
                        ...
                        ConfigToggle({
                            ...
                            initValue: exec('bash -c "wvkbd-mobintl'),
                            onChange: (self,newValue) => exec(bash -c "wvkbd-mobintel"),
                        }),
