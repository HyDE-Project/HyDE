...
alias in='hallwayde-shell pm install'
alias un='hallwayde-shell pm remove'
alias up='hallwayde-shell pm upgrade'
alias pl='hallwayde-shell pm search installed'
alias pa='hallwayde-shell pm search all'
alias g='git'
