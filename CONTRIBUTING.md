...
- The change log should be used to document changes from a user-perspective, instead of explaining the technical background (like commit messages) More information about DOORwayDE's change log format can be found [here](https://keepachangelog.com/).

5.1. **Optional But Recommended: Test with HydeVM** - You can test your changes in a VM using [HydeVM](Scripts/doorwaydevm/README.md) before submitting.
