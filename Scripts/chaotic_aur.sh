...
Invalid option: $1
Usage: $0 [option]
    --install [fresh]  󰛧  Install chaotic AUR ('fresh' assumes a fresh install)
    --uninstall        󰛧  Uninstall chaotic AUR ( requires you to run $0 --revert after)
    --revert           󰛧  Reinstall orphaned chaotic AUR packages
HELP
    ;;
esac
