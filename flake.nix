        ...
        in {
          ...
          config = lib.mkIf cfg.enable {
            ...
            xdg.configFile = {
              ...
              # style.css, theme.css, global.css = theme/session state; user-style.css =
              # user-editable stub seeded on first run; icon-sizes.json and position.json
              # = dynamic deltas generated by waybar.py at session start).
